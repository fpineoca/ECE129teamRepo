...
# Function to display dim green color
def display_green():
    for i in range(strip.numPixels()):
        strip.setPixelColor(i, Color(0, 50, 0))  # Dim green color (R=0, G=50, B=0)
    strip.show()

# Display dim green color
display_green()

# Keep the green color for 5 seconds
time.sleep(5)
